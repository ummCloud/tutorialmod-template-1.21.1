package net.umcloud.tutorialmod.datagen;
...
import net.umcloud.tutorialmod.block.custom.PinkGarnetLampBlock;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.KAUPEN_SMITHING_TEMPLATE, Models.HANDHELD);
